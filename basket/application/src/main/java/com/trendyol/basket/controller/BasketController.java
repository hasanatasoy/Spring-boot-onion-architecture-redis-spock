...
public interface BasketController {
    ...
    ApiResponse<GetBasketResponse> get(long basketId);
    ApiResponse<DeleteItemFromBasketResponse> delete(DeleteItemFromBasketRequest deleteItemFromBasketRequest);
}
